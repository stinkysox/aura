  ...
  return (
    <div className="pt-40">
      <Section eyebrow="Instruments" num="N° 03">
        <h1 className="display-xl max-w-6xl"><Reveal>The most considered instruments, used least.</Reveal></h1>
      </Section>
      <div className="px-6 md:px-12">
        <div className="mx-auto max-w-[1700px] space-y-48">
          {technology.map((t, i) => (
            <FadeIn key={t.name} delay={0.05}>
              <article className={`grid grid-cols-12 gap-6 md:gap-10 items-center ${i % 2 ? "md:[&>*:first-child]:order-2" : ""}`}>
