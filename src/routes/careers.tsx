...
export const Route = createFileRoute("/careers")({
  head: () => ({
    meta: [
      { title: "Careers — AURA Skin and Hair Clinic" },
      { name: "description", content: "On joining the clinic." },
      { property: "og:title", content: "Careers — AURA Skin and Hair Clinic" },
      { property: "og:description", content: "Open positions at AURA Skin and Hair Clinic." },
    ],
  }),
  component: Careers,
});
          ...
          {roles.map((r, i) => (
            <FadeIn key={r.t} delay={i * 0.04}>
              <div className="grid grid-cols-12 items-baseline gap-4 border-t border-border py-12">
                ...
                <span className="col-span-6 md:col-span-3 text-xs uppercase tracking-[0.22em] text-graphite">
                  {r.loc}
                </span>
                <span className="col-span-6 md:col-span-1 text-right text-xs uppercase tracking-[0.22em] text-graphite">
                  → Apply
                </span>
              </div>
            </FadeIn>
